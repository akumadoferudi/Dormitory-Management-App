...
class AdminKostIndexPage extends StatefulWidget {
  const AdminKostIndexPage({super.key});

  @override
  State<AdminKostIndexPage> createState() => _AdminKostIndexPageState();
}

class _AdminKostIndexPageState extends State<AdminKostIndexPage> {
